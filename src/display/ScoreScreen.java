...
public class ScoreScreen implements Screen {
    ...
    public void paint() {
        ...
        gc.fillText("Defender Hall of Fame", DefenderGame.SCREEN_WIDTH/2, DefenderGame.SCREEN_HEIGHT / 10);
        ...
        for (int i = 0; i < scores.length; i++) {
            ...
            gc.fillText(score.getName(), 2 * DefenderGame.SCREEN_WIDTH / 6, 96 + i * 32);
            gc.fillText("" + score.getScore(), 4 * DefenderGame.SCREEN_WIDTH / 6, 96 + i * 32);
        }
        gc.setTextAlign(TextAlignment.CENTER);
        gc.setTextBaseline(VPos.CENTER);
        gc.setFont(new Font("Arial", 28));
        gc.fillText("Press 'M' to return to the Main Menu", DefenderGame.SCREEN_WIDTH/2, DefenderGame.SCREEN_HEIGHT / 10 * 9);
    }
}
